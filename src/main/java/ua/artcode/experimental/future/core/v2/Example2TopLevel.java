package ua.artcode.experimental.future.core.v2;
...
public class Example2TopLevel {
    ...
    public void _01testPositiveTest(){
        ...
        MyAssert.assertEquals(new ContactInfo(new User(19, "Ivan"), new Address("Kiev", "Ushynsk", "3")),
                actual);
    }
