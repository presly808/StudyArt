        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="${pageContext.request.contextPath}/user-menu/show-user/<security:authentication property="principal.username" />"><i class="fa fa-user fa-fw"></i> User Profile</a>
                    </li>
