                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/logout">
                            ...
                            <p><input type="submit" class="btn" value="logout"></p>
                        </form>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Courser<span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Task Group<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_TEACHER')">
                    ...
                    <security:authorize
                            access="hasAnyRole('ROLE_ADMIN,ROLE_TEACHER')">
                        <li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>User menu<span
                    ...
                    <security:authorize
                            access="hasAnyRole('ROLE_ADMIN,ROLE_TEACHER')">
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Admin Menu<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
