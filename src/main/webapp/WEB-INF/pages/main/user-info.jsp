...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Progress of <i>${user.name}</i> <span class="label label-info">Role: ${role}</span>
            ...
            <div class="row">
                ...
                <ul class="list-group">
                    <c:forEach var="course" items="${user.subscribedCourses}">
                        ...
                        <c:set var="progressPercent" value="${(100 * course.performedLesson) / course.amountLessons}"/>

                        <a href="${CONTEXT_PATH}/course-menu/show-course/${course.title}?user=${user.name}"
                           class="list-group-item">${course.title}
                                    <span style="float: right">
                                            ${course.performedLesson} / ${course.amountLessons}
                                    </span>
                        </a>
