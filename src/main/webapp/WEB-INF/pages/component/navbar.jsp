...
<nav id="mainNavbar" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <ul class="nav navbar-top-links navbar-right">
    ...
    <!-- /.dropdown -->
    <li class="dropdown">
      <a class="dropdown-toggle" href="${CONTEXT_PATH}/user-menu/show-user/<security:authentication property="principal.username"/>">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-user">
        ...
        <li><a href="${CONTEXT_PATH}/user-menu/show-user/<security:authentication property="principal.username"/>">
