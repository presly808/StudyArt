...
<form:form action="${pageContext.request.contextPath}/task-menu/add-task" modelAttribute="task"
    ...
    <label>
        <form:textarea path="examples" rows="3" cols="50"/>
    ...
    <label>
        <form:textarea path="template" rows="4" cols="50"/>
    ...
    <label>
            <textarea name="data_points" rows="6" cols="50"><c:if
    ...
    <label>
        <form:textarea path="solution" rows="5" cols="50"/>
